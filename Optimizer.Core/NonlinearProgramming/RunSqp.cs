...
namespace Optimizer.Core.NonlinearProgramming
{
    public static class RunSqp
    {
            ...
            SqpOptions options = null)
        {
            ...
            return solver.Solve(objective, gradient, constraints, initialGuess, out info, options);
        }
            ...
            Matrix<double> initialHessian = null)
        {
            ...
            var solution = solver.Solve(problem, options, out info, out multipliers, out activeSet, initialHessian);
