    ...
    public sealed class SequentialQuadraticProgrammingSolver
    {
            ...
            out List<int> activeSet)
        {
            ...
            for (var iteration = 0; iteration < maxIterations; iteration++)
            {
                ...
                {
                    ReportProgress(options, x, info.SqpCount, composite, rawObjective, violation, info);
                    break;
                }
            ...
            ReportProgress(options, best, info.SqpCount, bestObjective, bestRawObjective, bestViolation, info);
            ...
            SqpInfo info)
        {
            ...
            if (options.LegacyProgressCallback != null && iterate != null)
            {
                options.LegacyProgressCallback.Invoke(iterate.Clone(), composite, rawObjective, violation);
            }
